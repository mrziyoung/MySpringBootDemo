...
import com.young.boot.bootdemo.service.IRelationshipService;
import com.young.boot.bootdemo.util.BlogUtils;
import com.young.boot.bootdemo.util.DateKit;
import com.young.boot.bootdemo.util.Tools;
...
public class ContentServiceImpl implements IContentService {
    ...
    public String publish(ContentVo contents) {
        ...
        if (StringUtils.isNotBlank(contents.getSlug())) {
            ...
            if (!BlogUtils.isPath(contents.getSlug())) return "您输入的路径不合法";
