package com.young.boot.bootdemo.service.impl;

import com.github.pagehelper.PageHelper;

import com.young.boot.bootdemo.constant.WebConst;
import com.young.boot.bootdemo.controller.admin.AttachController;
import com.young.boot.bootdemo.dao.AttachVoMapper;
import com.young.boot.bootdemo.dao.CommentVoMapper;
import com.young.boot.bootdemo.dao.ContentVoMapper;
import com.young.boot.bootdemo.dao.MetaVoMapper;
import com.young.boot.bootdemo.dto.MetaDto;
import com.young.boot.bootdemo.dto.Types;
import com.young.boot.bootdemo.exception.TipException;
import com.young.boot.bootdemo.model.bo.ArchiveBo;
import com.young.boot.bootdemo.model.bo.BackResponseBo;
import com.young.boot.bootdemo.model.bo.StatisticsBo;
import com.young.boot.bootdemo.model.vo.*;
import com.young.boot.bootdemo.service.ISiteService;
import com.young.boot.bootdemo.util.BlogUtils;
import com.young.boot.bootdemo.util.DateKit;
import com.young.boot.bootdemo.util.ZipUtils;
import com.young.boot.bootdemo.util.backup.Backup;
...
public class SiteServiceImpl implements ISiteService {
    ...
    public StatisticsBo getStatistics() {
        ...
        statistics.setArticles((long) articles);
        statistics.setComments((long) comments);
        statistics.setAttachs((long) attachs);
        statistics.setLinks((long) links);
